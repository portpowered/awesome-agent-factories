...
- [AutoGen reimagined: Launching AutoGen 0.4](https://devblogs.microsoft.com/autogen/autogen-reimagined-launching-autogen-0-4/) - Microsoft devblog on AutoGen 0.4's event-driven core runtime and AgentChat orchestration APIs for scalable multi-agent delegation, handoffs, and distributed coordination workflows.
...
- [How We Deployed our Multi-Agent Flow to LangGraph Cloud](https://blog.langchain.com/how-we-deployed-our-multi-agent-flow-to-langgraph-cloud-2/) - LangChain post on shipping a GPT-Researcher multi-agent graph to LangGraph Cloud with API-triggered orchestration, shared state coordination, and LangSmith group-level evaluation traces.
